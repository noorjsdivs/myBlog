...
function Article() {
  ...
  return (
    <div>
      <Header />
      {submitted ? (
        <div className="flex flex-col mt-10 py-10 my-10 bg-yellow-600 text-white max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <hr className="py-3 mt-2 border-yellow-500" />
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 focus:ring outline-none mb-5"
