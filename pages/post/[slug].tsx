  ...
  return (
    <main className="font-body">
      ...
      <img
        ...
        alt="banner image"
      />
      <article className="max-w-3xl mx-auto p-5 bg-red-50">
      ...
      <hr className="max-w-lg my-5 border border-red-500 mx-auto" />
      {submitted ? (
        <div className="flex flex-col py-10 my-10 bg-red-600 text-white max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-red-500 focus:ring outline-none"
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-red-500 focus:ring outline-none"
          ...
          <input
            className="shadow bg-red-500 hover:bg-red-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer"
            type="submit"
          />
        </form>
      )}
      ...
      <div className="flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-red-600 shadow space-y-2">
        ...
        {post.comments.map((comment) => (
          <div key={comment._id}>
            <p>
              <span className="text-red-600"> {comment.name}</span> :{" "}
              {comment.comment}
            </p>
          </div>
        ))}
